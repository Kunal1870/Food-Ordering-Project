...
export const ORDER_DETAILS_REQUEST = "ORDER_DEATAILS_REQUEST";
export const ORDER_DETAILS_SUCCESS = "ORDER_DEATAILS_SUCCESS";
export const ORDER_DETAILS_FAIL = "ORDER_DEATAILS_FAIL";
